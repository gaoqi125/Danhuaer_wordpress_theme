...
?>
        ...
        <h1 class="page-title author"><?php printf( __( 'Author Archives: %s', 'danhuaer' ), "<span class='vcard'>" . get_the_author() . "</span>" ); ?></h1>
		  </div>
		 </div>
<?php /*?><?php
...
if ( get_the_author_meta( 'description' ) ) : ?>
					<div id="entry-author-info">
						<div id="author-avatar">
							<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'danhuaer_author_bio_avatar_size', 60 ) ); ?>
						</div><!-- #author-avatar -->
						<div id="author-description">
							<h2><?php printf( __( 'About %s', 'danhuaer' ), get_the_author() ); ?></h2>
